...
export function mapPositionUpdateToVehicle(update: PositionUpdate): VehiclePosition {
  return {
    id: update.vin,
    ...
    lastTimestamp: update.timestamp ? Number(update.timestamp.epochMillis) : Date.now(),
  };
}
